...
class _MyHomePageState extends State<MyHomePage> with WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Home Automation', style: TextStyle(fontFamily: 'Marmelad', fontSize: 26, fontWeight: FontWeight.bold)),
          ...
          Padding(
            ...
            child: Row(
              ...
              children: sensors.entries.map((entry) {
                ...
                return Column(
                  children: [
                    Text(sala, style: const TextStyle(fontFamily: 'Marmelad', fontWeight: FontWeight.bold, fontSize: 20)),
                    Text(
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                final entry = relayStates.entries.elementAt(index);
                return _buildAnimatedRelayButton(entry.key, entry.value);
              },
            ),
          ),
        ],
